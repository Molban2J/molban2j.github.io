...
##### <p style="text-align:center">이 태그는 부등호 등 수학기호를 쓰기 위해서 사용한다.</p>
...
```
##### <p style="text-align:center">keyword가 존재한다면 keyword 검색</p>
...
##### <p style="text-align:center">test가 잘 작동한다.</p>
...
##### <p style="text-align:center">어째서인지 keyword로 검색한 결과로 나오는게 아니라 이전과 똑같이 나온다.</p>
...
cri.setKeyword("홍준");
```
##### <p style="text-align:center">setKeyword의 순서가 잘못 됐다.</p>
...
##### <p style="text-align:center">변경 후</p>

<br>

![image]({{ site.baseurl }}/images/20230512_145455.png)

##### <p style="text-align:center">잘 작동되는 모습</p>
...
##### <p style="text-align:center">service 생성</p>

![image]({{ site.baseurl }}/images/20230512_145919.png)

##### <p style="text-align:center">serviceImpl 생성</p>
...
```
##### <p style="text-align:center">기존의 controller</p>
...
```
##### <p style="text-align:center">변경 후<br>lombok의 data어노테이션이 있어도 getter/setter를 정의해주면 나중에 따로 정의한 getter/setter를 기준으로 데이터를 매핑한다.</p>
...
##### <p style="text-align:center">실행 결과 <br> 매우 이상하긴한데 나오긴 나온다. 일단 css적용해보기로</p>


![image]({{ site.baseurl }}/images/20230512_154605.png)

##### <p style="text-align:center">쨘</p>
...
```
##### <p style="text-align:center">PageVO</p>
...
```
##### <p style="text-align:center">AuthorMapper.java에 추가</p>
...
```
##### <p style="text-align:center">AuthorMapper.xml에 추가</p>

![image]({{ site.baseurl }}/images/20230512_162114.png)

##### <p style="text-align:center">JUnitTest성공</p>
...
```
##### <p style="text-align:center">AdminController에 authorManage매퍼에 삽입</p>
...
```
##### <p style="text-align:center">authorMange.jsp에 페이지 버튼 삽입</p>
...
```
##### <p style="text-align:center">버튼을 누르면 페이지 값들이 넘어가도록 폼태그 작성</p>
...
$(".pageMaker_btn a").on("click", function(e){
    ...
    moveForm.submit();
```
##### <p style="text-align:center">script문</p>


![image]({{ site.baseurl }}/images/20230512_164043.png)

##### <p style="text-align:center">실행했을때 모습. css적용하기 전 모습이다.</p>
